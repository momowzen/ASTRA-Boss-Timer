...
const HELP_EN = [
  ...
  '',
  '**⏱ Boss Timer**',
  '`kill <bossname>` → Record boss kill using current JST.',
  '> Example: `kill Venatus`',
  '`<bossname> x` → Shortcut to record a boss kill.',
  '> Example: `Venatus x`',
...
const HELP_KO = [
  ...
  '',
  '**⏱ 보스 타이머**',
  '`처치 <보스명>` → 현재 JST 기준으로 보스 처치를 기록합니다.',
  '> 예시: `처치 베나투스`',
  '`<보스명> x` → 보스 처치를 기록하는 단축 입력입니다.',
  '> 예시: `베나투스 x`',
...
const HELP_JA = [
  ...
  '',
  '**⏱ ボスタイマー**',
  '`討伐 <ボス名>` → 現在のJSTでボス討伐を記録します。',
  '> 例: `討伐 ベナトゥス`',
  '`<ボス名> x` → ボス討伐を記録する省略入力です。',
  '> 例: `ベナトゥス x`',
